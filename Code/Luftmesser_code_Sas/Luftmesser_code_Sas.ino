/*
 * Projekt Luftmessgerät version 1, Sas
 * Level 2
 * C. Wüpping, 2022
...
#define SENSOR_PIN A3  // Sensor (MQ 135), Pin PD5
#define LED1_PIN 11  // LED noch gut (grün), Pin D10, PD2 (hardware)
#define LED2_PIN 7  // LED geht so (gelb), Pin D7, PC5 (hardware)
#define LED3_PIN 5  // LED nicht OK (rot), Pin D4, PC3 (hardware)
