/*
 * Projekt Luftmessgerät version 1, Gerät A4
 * Level 2
 * C. Wüpping, 2022
...
#define SENSOR_PIN A4  // Sensor (MQ 135),    Pin D15/A4 (software), PD6 (hardware)
#define LED1_PIN 7  // LED noch gut (grün),  Pin D7 (sfotware),   PC5 (hardware)
#define LED2_PIN 9  // LED geht so (gelb),    Pin D9 (software),    PC7 (hardware)
#define LED3_PIN 11  // LED nicht OK (rot),    Pin D11(software),     PD2 (hardware)
