/*
 * Projekt Luftmessgerät version 1, Gerät A1
 * Level 2
 * C. Wüpping, 2022
...
#define LED1_PIN 14  // LED noch gut (grün),  Pin D13 (sfotware),   PD5 (hardware)
#define LED2_PIN 1  // LED geht so (gelb),    Pin D1 (software),    PA2 (hardware)
#define LED3_PIN 2  // LED nicht OK (rot),    Pin D1(software),     PA3 (hardware)
