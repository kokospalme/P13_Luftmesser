/*
 * Projekt Luftmessgerät version 1, Gerät A3
 * Level 2
 * C. Wüpping, 2022
...
#define SENSOR_PIN A1  // Sensor (MQ 135),    Pin D11/A1 (software), PD2 (hardware)
#define LED1_PIN 9  // LED noch gut (grün),  Pin D9 (sfotware),   PC7 (hardware)
#define LED2_PIN 6  // LED geht so (gelb),    Pin D6 (software),    PC4 (hardware)
#define LED3_PIN 5  // LED nicht OK (rot),    Pin D5(software),     PC3 (hardware)
