...
#define SENSOR_PIN A4  // Sensor (MQ 135), Pin C4
#define LED1_PIN 5  // LED noch gut (grün), Pin A1
#define LED2_PIN 7  // LED geht so (gelb), Pin A2
#define LED3_PIN 10  // LED nicht OK (rot), Pin A3
